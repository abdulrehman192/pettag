...
class ParasiteItem extends StatefulWidget {
  const ParasiteItem({Key? key, required this.title, required this.image, required this.examList, required this.onStateUpdate, required this.petId}) : super(key: key);

  final String petId;
  final String title;
  final String image;
  final List<ParasiteControlModel> examList;
  final Function onStateUpdate;


  @override
  State<ParasiteItem> createState() => _ParasiteItemState();
}

class _ParasiteItemState extends State<ParasiteItem> {
            ...
            return GestureDetector(
                  ...
                  actions: [
                    ...
                    ElevatedButton(onPressed: () async {
                      ...
                      await FirebaseFirestore.instance
                          ...
                          .doc(widget.petId)
                          .set({
                        'parasite': FieldValue.arrayRemove([widget.examList[index].toJson()]),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                  Text('${widget.examList[index].medicineType}',),
  ...
  bool isPastDue(int index) {
    return DateTime.now().millisecondsSinceEpoch > int.parse(widget.examList[index].dueDate.toString()) ?? false;
  }
          ...
          child: Column(
            ...
            InkWell(
              ...
              TextButton(onPressed: () async {
                ...
                ParasiteControlModel examModel = ParasiteControlModel(
                  medicineType: typeController.text.toString(),
                  dueDate: dueDate,
                ...
                await FirebaseFirestore.instance
                    ...
                    .doc(widget.petId)
                    .set({
                  'parasite': FieldValue.arrayUnion([examModel.toJson()]),
                }, SetOptions(merge: true)).then((value) {
