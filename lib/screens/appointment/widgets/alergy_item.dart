...
class AlergyItem extends StatefulWidget {
  const AlergyItem({Key? key,required this.title,required  this.value, required this.allergiesController}) : super(key: key);
  ...
  @override
  State<AlergyItem> createState() => _AlergyItemState();
}

class _AlergyItemState extends State<AlergyItem> {
                  ...
                  child: ToggleSwitch(
                    ...
                    onToggle: (index) {
                      if(index == 0) {
                        isSelected = false;
                        selectedIndex = 0;
                      ProfilePage.allergyController.text = '';
                      } else {
                        isSelected = true;
                        selectedIndex = 1;
                      }
          ...
          Padding(
            ...
            child: TextFormField(
              maxLines: null,
                ...
                controller:  ProfilePage.allergyController,
                validator: (value) {
