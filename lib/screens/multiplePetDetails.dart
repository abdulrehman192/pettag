...
class MultiplePetDetailedScreen extends StatefulWidget {
  static const String petDetailedScreenRoute = 'MultiplePetDetailedScreen';

  const MultiplePetDetailedScreen({super.key});

  @override
  _MultiplePetDetailedScreenState createState() =>
      _MultiplePetDetailedScreenState();
}

class _MultiplePetDetailedScreenState extends State<MultiplePetDetailedScreen> {
