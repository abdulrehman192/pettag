...
class ComprehensiveItem extends StatefulWidget {
  const ComprehensiveItem({Key? key, required this.title, required this.image, this.examList, this.onStateUpdate, required this.petId}) : super(key: key);
  final String petId;
  final String title;
  final String image;
  ...
  @override
  State<ComprehensiveItem> createState() => _ComprehensiveItemState();
}

class _ComprehensiveItemState extends State<ComprehensiveItem> {
                  ...
                  actions: [
                    ...
                    ElevatedButton(onPressed: () async {
                      ...
                      await FirebaseFirestore.instance
                          ...
                          .doc(widget.petId)
                          .set({
                        'comprehensive': FieldValue.arrayRemove([widget.examList![index].toJson()]),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  Row(
                    ...
                    children: [
                       isPastDue(index) ?
                        const Text('Past Due', style: TextStyle(color: Colors.red),) : const Text(  'Due Date',style: TextStyle(color: Colors.green),),
                      isPastDue(index) ?
            ...
            InkWell(
              ...
              TextButton(onPressed: () async {
                ...
                await FirebaseFirestore.instance
                    ...
                    .doc(widget.petId)
                    .set({
                  'comprehensive': FieldValue.arrayUnion([examModel.toJson()]),
                }, SetOptions(merge: true)).then((value) {
