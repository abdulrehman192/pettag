...
class VacinationItem extends StatefulWidget {
  const VacinationItem({Key? key, required this.title, required this.image, required this.examList, required this.onStateUpdate, required this.petId}) : super(key: key);

  final String petId;
  final String title;
  final String image;
  final List<VacinationModel> examList;
  final Function onStateUpdate;


  @override
  State<VacinationItem> createState() => _VacinationItemState();
}

class _VacinationItemState extends State<VacinationItem> {
            ...
            return GestureDetector(
                  ...
                  actions: [
                    ...
                    ElevatedButton(onPressed: () async {
                      ...
                      await FirebaseFirestore.instance
                          ...
                          .doc(widget.petId)
                          .set({
                        'vacination': FieldValue.arrayRemove([widget.examList[index].toJson()]),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                  Text('${widget.examList[index].vacineType}',style: const TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold),),
          ...
          child: Column(
            ...
            InkWell(
              ...
              TextButton(onPressed: () async {
                ...
                VacinationModel examModel = VacinationModel(
                  vacineType: typeController.text.toString(),
                  dueDate: dueDate,
                ...
                await FirebaseFirestore.instance
                    ...
                    .doc(widget.petId)
                    .set({
                  'vacination': FieldValue.arrayUnion([examModel.toJson()]),
                }, SetOptions(merge: true)).then((value) {
